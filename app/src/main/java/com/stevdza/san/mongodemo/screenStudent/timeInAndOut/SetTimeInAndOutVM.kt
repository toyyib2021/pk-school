package com.stevdza.san.mongodemo.screenStudent.timeInAndOut
...
class SetTimeInAndOutStudentVM (): ViewModel() {
                ...
                try {
                    val result = withContext(Dispatchers.IO) {
                        AlkhairDB.updateTimeIn(timeInOut = TimeInOut().apply {
                            _id = BsonObjectId(hexString = this@SetTimeInAndOutStudentVM.objectId.value)
                            timeIn = this@SetTimeInAndOutStudentVM.timeIn.value
                ...
                try {
                    val result = withContext(Dispatchers.IO) {
                        AlkhairDB.updateTimeOut(timeInOut = TimeInOut().apply {
                            _id = BsonObjectId(hexString = this@SetTimeInAndOutStudentVM.objectId.value)
                            timeOut = this@SetTimeInAndOutStudentVM.timeOut.value
