...
class StaffMonthlyAttendanceReportDoc(private val context: Context
){
...
//                .setBackgroundColor(DeviceRgb(0, 92, 230))
            ...
            val daysPresent = createSmallBoldTextParagraph(staffAttendancePdf.presentDays, lighterBlack).setTextAlignment(TextAlignment.CENTER)
            val presentPercent = createSmallBoldTextParagraph(staffAttendancePdf.presentDaysPercent, lighterBlack).setTextAlignment(TextAlignment.CENTER)

            val absent = createSmallBoldTextParagraph("Absent", lighterBlack).setTextAlignment(TextAlignment.LEFT)
            val daysAbsent = createSmallBoldTextParagraph(staffAttendancePdf.absentDays, lighterBlack).setTextAlignment(TextAlignment.CENTER)
            val absentPercent = createSmallBoldTextParagraph(staffAttendancePdf.absentDaysPercent, lighterBlack).setTextAlignment(TextAlignment.CENTER)
